          ...
          <div class="p-4 text-white position-relative overflow-hidden"
            ...
            <div class="d-flex align-items-start justify-content-between gap-2">
              <div class="flex-grow-1 min-w-0">
                <h6 class="fw-bold mb-1 text-white" style="font-size:15px;">${p.modelo || 'Sin modelo'}</h6>
                <div class="d-flex align-items-center gap-2 flex-wrap mt-1">
                  <span class="text-white opacity-75 small">
                    <i class="bi bi-person me-1"></i>${cliente ? cliente.nombre : '—'}
                  </span>
                  ${estadoBadge}
                </div>
              </div>
              <span class="badge bg-white text-success fw-bold px-2 py-1 flex-shrink-0" style="font-size:13px;border-radius:10px;">
                ${p.area || 0} m²
              </span>
            </div>
          </div>
