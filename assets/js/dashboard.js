...
window.Dashboard = {
  ...
  _calcularLlamadasHoy(clientes, proyectos, pagos, seguimientos) {
    ...
    for (const c of clientes) {
      ...
      if (recHoy) {
        motivos.push({ icon: 'bi-bell-fill', color: '#ef4444', texto: `Recordatorio: "${recHoy.descripcion.substring(0,50)}"` });
        prioridad = 'urgente';
      }
          ...
          <div class="d-flex align-items-center gap-3 mb-2">
            ...
            <div class="flex-grow-1 min-w-0">
              <div class="d-flex align-items-center gap-2 flex-wrap">
                <span class="fw-bold" style="font-size:14px;">${c.nombre}</span>
                  ...
                  : top5Financiero.map((x, idx) => {
                      ...
                      return `
                        <div class="mb-3" style="animation:fadeInUp 0.3s ease ${idx * 0.07}s both;">
                          <div class="d-flex justify-content-between align-items-center mb-1">
                            <span class="small fw-semibold text-truncate" style="max-width:160px;">${x.c.nombre}</span>
